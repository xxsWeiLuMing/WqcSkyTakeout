...
public class ReportSeviceImpl implements ReportSevice {
    ...
    public void exportBusinessData(HttpServletResponse response) {
        ...
        BusinessDataVO monthlyData = workspaceService.getBusinessData(LocalDateTime.of(dateBegin, LocalTime.MIN), LocalDateTime.of(dateEnd, LocalTime.MAX));
        ...
        try {
            ...
            row.getCell(2).setCellValue(monthlyData.getTurnover());
            row.getCell(4).setCellValue(monthlyData.getOrderCompletionRate());
            row.getCell(6).setCellValue(monthlyData.getNewUsers());

            row = sheet.getRow(4);
            row.getCell(2).setCellValue(monthlyData.getValidOrderCount());
            row.getCell(4).setCellValue(monthlyData.getUnitPrice());
